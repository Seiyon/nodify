...
namespace TestWpfApplication.Runner.Blackboard
{
    ...
    {
        private readonly Dictionary<BlackboardKey, object?> _objects = new();

        public virtual IReadOnlyCollection<BlackboardKey> Keys => _objects.Keys;

        public virtual T? GetValue<T>(BlackboardKey key) where T : struct
        {
        ...
        public virtual T? GetObject<T>(BlackboardKey key) where T : class
        {
